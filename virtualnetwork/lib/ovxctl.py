...
def do_getVirtualHosts(gopts, opts, args):
    ...
    #temp=open('/home/likai/ovx-getvritualTopology/virtual-hosts.json','w')     #保存数据至本地
...
def do_getVirtualSwitchMapping(gopts, opts, args):
    ...
    #temp=open('/home/likai/ovx-getvritualTopology/virtual-switchMapping.json','w')     #保存数据至本地
    #temp.write(json.dumps(result))
    #temp.close()
    print json.dumps(result)
...
def do_getVirtualTopology(gopts, opts, args):
    ...
    #temp=open('/home/likai/ovx-getvritualTopology/virtual-topology.json','w')     #保存数据至本地
    #temp.write(json.dumps(result))
    #temp.close()
    print json.dumps(result)
